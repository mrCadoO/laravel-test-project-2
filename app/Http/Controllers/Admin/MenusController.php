...
class MenusController extends AdminController {
    ...
    public function getMenus(){
        ...
        $m_builder = Menu::make('forMenuPart', function($m) use($menu) {
    ...
    public function create(){
        ...
        $list = [];
        $list = array_add($list, '0', 'Не используеться');
        ...
        $filters = \Corp\Filter::select(['id', 'title', 'alias'])->get()->reduce(function($returnFiltres, $filtr){
            $returnFiltres[$filtr->alias] = $filtr->title;
            return $returnFiltres;
